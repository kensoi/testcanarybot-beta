...
from ._values import project_name
from ._values import expression


async def cover_coroutine(self, *args, **kwargs):
    pass
...
class libraryModule:
    ...
    start = cover_coroutine # if user don't need to use this function
